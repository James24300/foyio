...
class CryptoView(QWidget):
    ...
    def _build_simulator_tab(self):
        ...
        self._wi_chart.setStyleSheet("background:#26292e; border:none; border-radius:8px;")
        self._wi_chart.setVisible(False)
        _empty_wi = QChart()
        _empty_wi.setBackgroundBrush(QColor("#26292e"))
        _empty_wi.setBackgroundRoundness(0)
        _empty_wi.legend().hide()
        _empty_wi.layout().setContentsMargins(0, 0, 0, 0)
        self._wi_chart.setChart(_empty_wi)
        ...
        self._cmp_chart.setStyleSheet("background:#26292e; border:none; border-radius:8px;")
        _empty_cmp = QChart()
