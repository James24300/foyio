...
SECTIONS = [
    ...
    ("Outils & Import", "#3b82f6", [
        ...
        ("📄", "Rapport fiscal",
         ["Export PDF annuel directement sur le Bureau",
          "Revenus, dépenses & ventilation mensuelle",
          "Répartition par catégorie classée"]),
        ("📥", "Import multi-format",
    ...
    ("Sécurité & Confort", "#f59e0b", [
        ("🔒", "Sécurité",
         ["Mot de passe au démarrage (SHA-256)",
          "Verrouillage automatique après inactivité",
          "Confirmation avant chaque suppression"]),
        ("🔔", "Notifications",
         ["Alertes Windows pour les récurrentes à venir",
