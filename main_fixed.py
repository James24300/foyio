...
class MainWindow(QWidget):
    ...
    ("btn_more",         " Plus",         "other.png"),
        ...
        for view in [
            ...
            self.tools, self.ideas, self.settings_v, self.features_v, self.about
        ]:
    ...
    def open_more_menu(self):
        ...
        menu.addSection("Gestion")
        menu.addAction("Catégories", lambda: self.set_active(3))
        menu.addAction("Récurrentes", lambda: self.set_active(5))

        menu.addSection("Finances")
        menu.addAction("Épargne", lambda: self.set_active(6))
        menu.addAction("Prêts", lambda: self.set_active(8))

        menu.addSection("Outils")
        menu.addAction("Outils", lambda: self.set_active(9))
        menu.addAction("Calculatrice", self._open_calculator)

        menu.addSection("Application")
        menu.addAction("Paramètres", lambda: self.set_active(11))
        menu.addAction("Fonctionnalités", lambda: self.set_active(12))
        menu.addAction("À propos", lambda: self.set_active(13))
        menu.addAction("Boîte à idées", lambda: self.set_active(10))
    ...
    def toggle_sidebar(self):
        ...
        labels = ["", "", "", "", "", "", "", "", "", "", "", "", "", ""] if expanded else [
            ...
            " Boîte à idées", " Paramètres", " Fonctionnalités", " À propos"
        ]
